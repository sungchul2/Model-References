...
config = {
    "ocr_lite_hrnet_18_mod2": {'type': 'OTXEncoderDecoder', 'backbone': {'extra': {'add_input': False,
                        'num_stages': 3,
                        'out_aggregator': {'enable': False},
                        'out_modules': {'conv': {'channels': 320,
                                                 'enable': False},
                                        'local_att': {'enable': False},
                                        'position_att': {'enable': False,
                                                         'key_channels': 128,
                                                         'psp_size': (1,
                                                                      3,
                                                                      6,
                                                                      8),
                                                         'value_channels': 320}},
                        'stages_spec': {'module_type': ('LITE', 'LITE', 'LITE'),
                                        'num_blocks': (2, 2, 2),
                                        'num_branches': (2, 3, 4),
                                        'num_channels': ((40, 80),
                                                         (40, 80, 160),
        ...
        'decode_head': {'align_corners': False,
                 ...
                 'num_classes': 19,
                 'num_convs': 1,
                 'type': otx_head_factory},
        'pretrained': None,
        'task_adapt': {'dst_classes': ['background',
                                'road',
                                'sidewalk',
                                'building',
                                'wall',
                ...
                'src_classes': ['background',
                                ...
                                'nebulosa',
                                'European fire salamander, Salamandra '
                                'salamandra',
                                ...
                                'tree frog, tree-frog',
                                'tailed frog, bell toad, ribbed toad, tailed '
                                'toad, Ascaphus trui',
                                'loggerhead, loggerhead turtle, Caretta '
                                'caretta',
                                'leatherback turtle, leatherback, leathery '
                                ...
                                'American chameleon, anole, Anolis '
                                'carolinensis',
                                ...
                                'Komodo dragon, Komodo lizard, dragon lizard, '
                                ...
                                'green mamba',
                                'sea snake',
                                'horned viper, cerastes, sand viper, horned '
                                'asp, Cerastes cornutus',
                                'diamondback, diamondback rattlesnake, '
                                'Crotalus adamanteus',
                                'sidewinder, horned rattlesnake, Crotalus '
                                'cerastes',
                                'trilobite',
                                'harvestman, daddy longlegs, Phalangium opilio',
                                'scorpion',
                                'black and gold garden spider, Argiope '
                                'aurantia',
                                ...
                                'quail',
                                'partridge',
                                'African grey, African gray, Psittacus '
                                'erithacus',
                                'macaw',
                                ...
                                'platypus, duckbill, duckbilled platypus, '
                                'duck-billed platypus, Ornithorhynchus '
                                'anatinus',
                                'wallaby, brush kangaroo',
                                'koala, koala bear, kangaroo bear, native '
                                ...
                                'fiddler crab',
                                'king crab, Alaska crab, Alaskan king crab, '
                                'Alaska king crab, Paralithodes camtschatica',
                                'American lobster, Northern lobster, Maine '
                                ...
                                'albatross, mollymawk',
                                'grey whale, gray whale, devilfish, '
                                'Eschrichtius gibbosus, Eschrichtius robustus',
                                'killer whale, killer, orca, grampus, sea '
                                'wolf, Orcinus orca',
                                'dugong, Dugong dugon',
                                'sea lion',
                                'Chihuahua',
                                ...
                                'terrier, American pit bull terrier, pit bull '
                                'terrier',
                                'Bedlington terrier',
                                'Border terrier',
                                'Kerry blue terrier',
                                ...
                                'Rottweiler',
                                'German shepherd, German shepherd dog, German '
                                'police dog, alsatian',
                                ...
                                'standard poodle',
                                'Mexican hairless',
                                'timber wolf, grey wolf, gray wolf, Canis '
                                'lupus',
                                'white wolf, Arctic wolf, Canis lupus '
                                'tundrarum',
                                'red wolf, maned wolf, Canis rufus, Canis '
                                'niger',
                                'coyote, prairie wolf, brush wolf, Canis '
                                'latrans',
                                ...
                                'needle, sewing needle, snake feeder, snake '
                                ...
                                'hamster',
                                'porcupine, hedgehog',
                                'fox squirrel, eastern fox squirrel, Sciurus '
                                'niger',
                                'marmot',
                                'beaver',
                                ...
                                'Madagascar cat, ring-tailed lemur, Lemur '
                                'catta',
                                ...
                                'barracouta, snoek',
                                'eel',
                                'coho, cohoe, coho salmon, blue jack, silver '
                                ...
                                'carton',
                                'car wheel',
                                'cash machine, cash dispenser, automated '
                                'teller machine, automatic teller machine, '
                                ...
                                'chain',
                                'chainlink fence',
                                'chain mail, ring mail, mail, chain armor, '
                                ...
                                'cinema, movie theater, movie theatre, movie '
                                'house, picture palace',
                                ...
                                'gas pump, gasoline pump, petrol pump, island '
                                'dispenser',
                                'goblet',
                                'go-kart',
                                'golf ball',
                                ...
                                'hammer',
                                'hamper',
                                'hand blower, blow dryer, blow drier, hair '
                                'dryer, hair drier',
                                ...
                                'oil filter',
                                'organ, pipe organ',
                                'oscilloscope, scope, cathode-ray '
                                'oscilloscope, CRO',
                                'overskirt',
                                'oxcart',
                                'oxygen mask',
                                ...
                                'stove',
                                'strainer',
                                'streetcar, tram, tramcar, trolley, trolley '
                                'car',
                                'stretcher',
                                ...
                                'Cypripedium calceolus, Cypripedium '
                                'parviflorum',
                                'corn',
                                'acorn',
                                ...
                                'bolete',
                                'ear, spike, capitulum',
                                'toilet tissue, toilet paper, bathroom '
                                'tissue']},
        'test_cfg': {'mode': 'whole'},
        'train_cfg': {'mix_loss': {'enable': False, 'weight': 0.1}},
    },
    "ocr_lite_hrnet_s_mod2": {'type': 'OTXEncoderDecoder', 'backbone': {'extra': {'add_input': False,
                        'num_stages': 2,
                        'out_aggregator': {'enable': False},
                        'out_modules': {'conv': {'channels': 160,
                                                 'enable': False},
                                        'local_att': {'enable': False},
                                        'position_att': {'enable': False,
                                                         'key_channels': 64,
                                                         'psp_size': (1,
                                                                      ...
                                                                      8),
                                                         'value_channels': 240}},
                        'stages_spec': {'module_type': ('LITE', 'LITE'),
              ...
              'norm_eval': False,
              'type': 'LiteHRNet'},
 'decode_head': {'aggregator_merge_norm': None,
